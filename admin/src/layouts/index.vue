  ...
  <div class="admin-container">
    ...
    <template v-else>
      <el-container v-if="mode === 'vertical'">
        ...
        <el-container class="container" :style="{ left: isCollapse ? '65px' : '210px' }">
          <el-header class="header" :class="{ fixed: fixedHead, notag: !tag }" height="60px"
            :style="{ left: isCollapse ? '65px' : '210px' }">
